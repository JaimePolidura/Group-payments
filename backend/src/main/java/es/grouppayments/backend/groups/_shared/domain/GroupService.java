...
import es.grouppayments.backend.groups.edit.GroupEdited;
...
public class GroupService {
    ...
    public void create(UUID groupId, String title, double money, UUID adminUserId, Currency currency){
        groups.save(new Group(groupId, title, LocalDateTime.now(), money, adminUserId, GroupState.PROCESS, currency));
